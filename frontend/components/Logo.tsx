...
// Tight crop to the mark's own bounding box, squared off on the taller axis and
// centred. Used by the bare variant so the head fills its box — with no tile
// behind it, the ~14 units of padding baked into the 100-unit artboard would
// just make the mark look undersized next to a tiled one of the same `size`.
const MARK_VIEWBOX = "13.37 13.5 73.1 73.1";
...
export default function Logo({
  ...
  if (bare) {
    return (
      <svg {...common} viewBox={MARK_VIEWBOX}>
