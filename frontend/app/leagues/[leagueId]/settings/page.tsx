              ...
              {pendingMembers.map((m: any, idx: number) => (
                <div key={m.userId} style={{
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
                    <HelmetAvatar color={m.helmetColor ?? "#0E92EB"} initials={m.user.displayName.slice(0, 2).toUpperCase()} size={30} />
        ...
        <div className="card" style={{ marginBottom: 10, padding: 0, overflow: "hidden" }}>
          {members.map((m: any, idx: number) => (
            <div key={m.userId} style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
                <HelmetAvatar color={m.helmetColor ?? "#0E92EB"} initials={m.displayName.slice(0, 2).toUpperCase()} size={28} />
